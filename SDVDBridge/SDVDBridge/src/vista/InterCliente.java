...
public class InterCliente extends javax.swing.JInternalFrame {
    ...
    if (!txt_nombre.getText().isEmpty() && !txt_apellido.getText().isEmpty() && !txt_cedula.getText().isEmpty() && !txt_telefono.getText().isEmpty()) {
        
        // Verificar que la cédula y el teléfono sean iguales
        if (!txt_cedula.getText().trim().equals(txt_telefono.getText().trim())) {
            JOptionPane.showMessageDialog(null, "Ambos teléfonos deben ser iguales.");
            txt_cedula.setBackground(Color.red);
            txt_telefono.setBackground(Color.red);
        }
        // Verificar que ambos tengan exactamente 10 caracteres numéricos
        else if (txt_cedula.getText().length() != 10 || !txt_cedula.getText().matches("[0-9]+") || 
                 txt_telefono.getText().length() != 10 || !txt_telefono.getText().matches("[0-9]+")) {
            JOptionPane.showMessageDialog(null, "Ambos teléfonos deben tener exactamente 10 números.");
            txt_cedula.setBackground(Color.red);
            txt_telefono.setBackground(Color.red);
        } else {
            ...
            if (!controlCliente.existeCliente(txt_cedula.getText().trim())) {
                ...
                // Resetear el fondo de los campos
